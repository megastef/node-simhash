void function() {
    ...
    function summary(file1, file2, silent) {
        ...
        var s1 = createBinaryString(hash1)
        var s2 = createBinaryString(hash2)
        if (!silent) {
          console.log("File1 simhash:", s1);
          console.log("File2 simhash:", s2);
        ...
        return {
            simHash1: s1, 
            simhHash2: s2, 
            simHashValue: Math.round(simhashval * 100), 
